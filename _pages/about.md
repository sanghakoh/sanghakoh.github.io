...
<style>
/* al-folio 기본 페이지 헤더 숨김 → 제목 박스를 맨 위로 */
...
.research-card img { width: 104px; height: 104px; }
.research-card h3 { margin: 1rem 0 .4rem; color: #0E4A8A; }
...
<div class="lab-hero">
  ...
  <p class="lab-affil">Dept. of Computer Science and Engineering · Hanyang University ERICA
</div>
...
SUNLab is **actively recruiting** motivated M.S. and Ph.D. students and
undergraduate interns who are excited about security and privacy. If solving
hard problems across networks, machine learning, and human factors sounds like
you, reach out by email with a short note about your background and interests.

📧 [sanghak@hanyang.ac.kr](mailto:sanghak@hanyang.ac.kr)
